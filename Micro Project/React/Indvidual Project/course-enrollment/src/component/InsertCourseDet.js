...
constructor(){
    ...
    changeID=(val)=>{
        ...
        console.log("errorid: "+this.state.errorSID)
    ...
    handleSubmit=(e)=>{
        ...
        if(!error1 && !error2 && !error3 && !error4 && !error5){
            ...
            axios.post("http://localhost:3004/students",courseDet).then((Response)=>{document.getElementById('ResultDiv1').innerHTML="<b>Record inserted Successfully!!</b>"}).catch((error)=>console.log('Error ',error))
    ...
    return(
        ...
        <div >
            ...
            <div >
                ...
                <font color='red' font-weight='bold'>{this.state.errorcourse2}</font>
                <button class="btn btn-primary btn-md" type="submit" onClick={this.handleSubmit}>Insert</button>
